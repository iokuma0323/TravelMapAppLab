 ...
 * カスタムアダプター クラス
 */
public class CustomAdapter_Hotel extends ArrayAdapter<String> {
	 ...
	 * @param labelList
	 */
	public CustomAdapter_Hotel(Context context, int textViewResourceId, ArrayList<String> labelList) {
	...
	public View getView(int position, View view, ViewGroup viewGroup) {
		...
		if (position % 2 == 0) { // 行毎に背景色を変える
			vh.labelText.setBackgroundColor(Color.parseColor("#ff69b4"));
		} else {
			vh.labelText.setBackgroundColor(Color.parseColor("#ff1493"));
		}
