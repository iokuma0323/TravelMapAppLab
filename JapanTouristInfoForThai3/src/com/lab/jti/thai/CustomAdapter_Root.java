 ...
 * カスタムアダプター クラス
 */
public class CustomAdapter_Root extends ArrayAdapter<String> {
	 ...
	 * @param labelList
	 */
	public CustomAdapter_Root(Context context, int textViewResourceId, ArrayList<String> labelList) {
	...
	public View getView(int position, View view, ViewGroup viewGroup) {
		...
		if (position % 2 == 0) { // 行毎に背景色を変える
			vh.labelText.setBackgroundColor(Color.parseColor("#9932cc"));
		} else {
			vh.labelText.setBackgroundColor(Color.parseColor("#9400d3"));
		}
